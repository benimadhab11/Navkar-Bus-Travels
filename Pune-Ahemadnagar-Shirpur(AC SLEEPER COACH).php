...
<html>
<head>
<title>Pune-Ahemadnagar-Shirpur(AC SLEEPER COACH)Select seat</title>
...
<h1><center>Pune-Dhule-Shirpur(AC SLEEPER COACH)
</center></h1>
<center>
<h1>Select Seat AND Fill details</h1> 
<h4 style=color:red>*All fields are mandatory to fill</h4>
<form method="post" name="myForm" action="Pune-Ahemadnagar-Shirpur(AC SLEEPER COACH)insert.php" onsubmit="return validate()">
