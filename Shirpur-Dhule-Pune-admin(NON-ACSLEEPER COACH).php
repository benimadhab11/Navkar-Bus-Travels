...
<h2>Shirpur-Dhule-Pune(NON-ACSLEEPER COACH)</h2>
<h2>Seat Chart</h2>
...
echo"<td><a href='Shirpur to Pune via Nashik Sangamner Select Seat.php'><input type='button' value='Add Customer''></input></a></td>";
echo"<td><a href='Shirpur to Pune via Nashik Sangamner(Non-Ac)update.php'><input type='button' value='Update Information'></input></a></td>";
echo"<td><a href='bus30.php'><input type='button' value='Delete seat vise customer'></input></a></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
