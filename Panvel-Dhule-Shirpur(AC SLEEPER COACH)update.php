...
echo "<html>"; 
echo "<head>"; 
echo "<title>Panvel-Dhule-Shirpur(AC SLEEPER COACH)</title>"; 
...
echo "<h1><center>Panvel-Dhule-Shirpur(AC SLEEPER COACH)</center></h1>"; 
echo "<br><br>"; 
...
echo "<form method='post' name='myForm' action='Panvel-Dhule-Shirpur(AC SLEEPER COACH)update_progres.php' onsubmit='return validate()'>"; 
...
echo "<option value=\"Kalyan Shilpada\">Kalyan Shilpada</option>"; 
