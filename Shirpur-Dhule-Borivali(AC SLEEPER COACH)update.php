...
echo "<html>"; 
echo "<head>"; 
echo "<title>Shirpur-Dhule-Borivali(AC SLEEPER COACH)update</title>"; 
...
echo "<h1><center>Shirpur-Dhule-Borivali(AC SLEEPER COACH)</center></h1>"; 
echo "<br><br>"; 
...
echo "<form method='post' name='myForm' action='Shirpur-Dhule-Borivali(AC SLEEPER COACH)update_progres.php' onsubmit='return validate()'>"; 
...
echo "<tr>"; 
echo "<td>From:</td>"; 
echo "<td><select value=from name=from>"; 
...
echo "</td>"; 
echo "<td>To:</td>"; 
echo "<td><select value=to name=to>"; 
echo "<option value=SelectYourDestinationCity>Select Your Destination City</option>"; 
echo "<option value=Borevali>Borevali</option>"; 
echo "</td>"; 
echo "</tr><tr>"; 
echo ""; 
echo "<tr>"; 
echo "<td>Select Boarding Point:</td>"; 
echo "<td><select value=\"boarding_point\" name=\"boarding_point\">"; 
...
echo "<td><select value=\"Drop_point\" name=\"Drop_point\">"; 
echo "<option value=SelectYourDropPoint>Select Your Drop Point</option>"; 
echo "<option value=\"Borivali\">Borivali</option>"; 
