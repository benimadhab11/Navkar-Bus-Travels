...
<html>
<head>
<title>Shirpur-Dhule-Pune (AC SLEEPER COACH)
Select seat</title>
...
<h1><center>Shirpur-Dhule-Pune (AC SLEEPER COACH)
</center></h1>

<h1>Select Seat AND Fill details</h1> 
<h4 style=color:red>*All fields are mandatory to fill</h4>
<form method="post" name="myForm" action="Shirpur-Dhule-Pune(AC SLEEPER COACH)insert.php" onsubmit="return validate()">
<table cellspacing=20 cellpadding=10 style=font-size:20>

<tr>
<td>From:</td>
<td><select id=from name=from>
<option name=SelectYourStartCity>Select Your Start City</option>
<option name=Nashik>Nashik</option>
<option name=Dhule>Dhule</option>
<option name=Shirpur>Shirpur</option>
</td>


<td>To:</td>
<td><select id=to name=to>
<option name=SelectYourDestinationCity>Select Your Destination City</option>
<option name=Pune>Pune</option>
<option name=Nashik>Nashik</option></td>
</tr>
...
<option name=SelectYourboardPoint>Select Your Board Point</option>
<option name="ShirpurBusStop">Shirpur Bus Stop
<option name="DhuleGround">Dhule Ground
<option name="Nashik">Nashik</td>
</td>
</select>
...
<option name=SelectYourdrop_Point>Select Your droping Point</option>
<option name="Chakan">Chakan
<option name="Mulshi">Mulshi
<option name="Bhosari">Bhosari
<option name="Nashik Fata">Nashik Fata
<option name="Kasarwadi">Kasarwadi
<option name="Ophapodi">Ophapodi
<option name="Khadaki_Station">Khadaki  Station
<option name="ShivajiNagar(Engineeringcollege)">ShivajiNagar (Engineering college)
<option name="Sangavigaon">Sangavigaon
<option name="Kalewadi fata 14 Number Busstop">Kalewadi fata 14 Number Busstop
<option name="Dange chowk">Dange chowk 
<option name="Chaphekar Chowk">Chaphekar Chowk
<option name="Akurdi(Khandoba_chowk)"> Akurdi (Khandoba chowk)
<option name="NigadiBridge"> Nigadi Bridge
<option name=" Shakti-Bhakti Chowk(Last stop)"> Shakti-Bhakti Chowk(Last stop)</select>
</td>
</tr><tr>
