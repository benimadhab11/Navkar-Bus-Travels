...
<html>
<head>
<title>Borivali -Dhule-Shirpur(AC SLEEPER COACH)
Select seat</title>
...
<center>
<h1>Borivali -Dhule-Shirpur (AC SLEEPER COACH)</h1>
<h1>Select Seat AND Fill details</h1> 
<h4 style=color:red>*All fields are mandatory to fill</h4>
<form method="post" name="myForm" action="Borivali -Dhule-Shirpur(AC SLEEPER COACH)insert.php" onsubmit="return validate()">
...
<option value=Borevali>Borivali</option>
</td>
<td>To:</td>
...
<option value="DhuleGround">Dhule Ground</option></td>
</select>
</td>
</tr>
