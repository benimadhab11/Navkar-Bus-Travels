...
<h2>Shirpur-Dhule-Borivali(ACSLEEPERCOACH)</h2>
<h2>Seat Chart</h2>
...
echo"<td><a href='Shirpur-Dhule-Borivali(AC SLEEPER COACH).php'><input type='button' value='Add Customer'></input></a></td>";
echo"<td><a href='Shirpur-Dhule-Borivali(AC SLEEPER COACH)update.php'><input type='button' value='Update Information'></a></input></td>";
echo"<td><a href='bus50.php'><input type='button' value='Delete seat vise customer'></a></input></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
