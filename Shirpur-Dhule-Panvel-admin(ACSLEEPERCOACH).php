...
echo"<td><a href='Shirpur-Dhule-panvel(AC SLEEPER COACH).php'><input type='button' value='Add Customer'></input></a></td>";
echo"<td><a href='Shirpur-Dhule-Panvel(AC SLEEPER COACH)update.php'><input type='button' value='Update Information'></input></a></td>";
echo"<td><a href='bus70.php'><input type='button' value='Delete seat vise customer'></input></a></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
