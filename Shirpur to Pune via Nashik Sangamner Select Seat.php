...
<html>
<head>
<title>Shirpur to Pune via Nashik Sangamner(Non-Ac)Select seat</title>
...
<center>
<h1><center>Shirpur to Pune via Nashik Sangamner
(Non-Ac)</center></h1>
<h1>Select Seat AND Fill details</h1> 
<h4 style=color:red>*All fields are mandatory to fill</h4>
<form method="post" name="myForm" action="Shirpur to Pune via Nashik Sangamner(NON AC)insert.php" onsubmit="return validate()">
...
<option value=SelectYourDestinationCity>Select Your Start City</option>
<option value=Nashik>Nashik</option>
...
<option value="Nashik Fata">Nashik Fata</option>
<option value="Kasarwadi">Kasarwadi</option>
<option value="Ophapodi">Ophapodi</option>
<option value="Khadaki_Station">Khadaki  Station</option>
<option value="ShivajiNagar(Engineeringcollege)">ShivajiNagar (Engineering college)</option>
<option value="Sangavigaon">Sangavigaon</option>
<option value="Kalewadi fata 14 Number Busstop">Kalewadi fata 14 Number Busstop</option>
<option value="Dange chowk">Dange chowk</option>
<option value="Chaphekar Chowk">Chaphekar Chowk</option>
<option value="Akurdi(Khandoba_chowk)"> Akurdi (Khandoba chowk)</option>
<option value="NigadiBridge"> Nigadi Bridge</option>
<option value=" Shakti-Bhakti Chowk(Last stop)"> Shakti-Bhakti Chowk(Last stop)</option>
</td>
</select>
</td>
</tr>
