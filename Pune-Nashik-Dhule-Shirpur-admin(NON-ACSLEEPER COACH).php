...
<h2>Pune-Nashik-Dhule-Shirpur(NON-ACSLEEPER COACH).php</h2>
<h2>Seat Chart</h2>
...
echo"<td><a href='Pune to Shirpur via Nashik Sangamner Select Seat(Non-Ac).php'><input type='button' value='Add Customer'></input></a></td>";
echo"<td><a href='Pune to Shirpur via Nashik Sangamner(Non-Ac)update.php'><input type='button' value='Update Information'></a></input></td>";
echo"<td><a href='bus40.php'><input type='button' value='Delete seat vise customer'></a></input></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
