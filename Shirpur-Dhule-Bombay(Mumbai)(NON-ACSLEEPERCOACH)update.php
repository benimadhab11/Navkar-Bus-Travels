...
echo "<html>"; 
echo "<head>"; 
echo "<title>Shirpur-Dhule-Bombay(Mumbai)(NON-ACSLEEPERCOACH)</title>"; 
...
echo "<h1><center>Shirpur-Dhule-Bombay(Mumbai)(NON-ACSLEEPERCOACH)</center></h1>"; 
echo "<br><br>"; 
echo "<ul id='menu' align='center' bgcolor='#000'>"; 
echo "<li><a href='home1.php'>HOME</a></li>"; 
echo "<li><a href='.php'>About Us</a></li>"; 
echo "<li><a href='.php'>Buses On Rent</a></li>"; 
echo "<li><a href='.php'>Gallery</a></li>"; 
echo "<li><a href='.php'>Contact Us</a></li>"; 
echo "<li><a href='login.html'>Admin login</a></li>"; 
echo "</ul>"; 
echo ""; 
echo "<h1><center>Select Seat to update AND Fill details</h1> "; 
echo "<h4 style=color:red>*All fields are mandatory to fill</h4>"; 
echo "<form method='post' name='myForm' action='Shirpur-Dhule-Bombay(Mumbai)(NON-ACSLEEPERCOACH)update_progres.php' onsubmit='return validate()'>"; 
...
echo "<option value=panvel>Bombay</option>"; 
echo ""; 
echo ""; 
echo "</td>"; 
echo "</tr><tr>"; 
...
echo "<option value=\"DhuleGround\">Dhule Ground</option>"; 
echo "</td>"; 
echo "</select>"; 
echo ""; 
echo "</td>"; 
...
echo "<option value=\"kalyan Phata\">kalyan Phata</option>"; 
echo "<option value=\"kalyan Phata\">kalyan Phata</option>"; 
echo "<option value=\"Mankoli\">Mankoli</option>"; 
echo "<option value=\"Kharegaon Tollnaka\">Kharegaon Tollnaka</option>"; 
echo "<option value=\"Majivada\">Majivada</option>"; 
echo "<option value=\"Kapoorbavadi\">Kapoorbavadi</option>"; 
echo "<option value=\"Cadbowry\">Cadbowry</option>"; 
echo "<option value=\"Nitin Company\">Nitin Company</option>"; 
echo "<option value=\"Thane\">Thane</option>"; 
echo "<option value=\"Three hath Naka\">Three hath Naka</option>"; 
echo "<option value=\"Mulund Signal\">Mulund Signal</option>"; 
echo "<option value=\"Aaroli Bridge\">Aaroli Bridge</option>"; 
echo "<option value=\"Kanjurmarg Bridge\">Kanjurmarg Bridge</option>"; 
echo "<option value=\"Ghatkoper Bridge(Ramabai Colony)\">Ghatkoper Bridge(Ramabai Colony)</option>"; 
echo "<option value=\"Chambur(Amar Mahal)\">Chambur(Amar Mahal)</option>"; 
echo "<option value=\"Kula Signal(Chuna Bhatti)\">Kula Signal(Chuna Bhatti)</option>"; 
echo "<option value=\"Cyan Circle\">Cyan Circle</option>"; 
echo "<option value=\"Matunga Circle\">Matunga Circle</option>"; 
echo "<option value=\"Dadar(Chitra & Talkis)\">Dadar(Chitra & Talkis)</option>"; 
echo "<option value=\"Parel\">Parel</option>"; 
echo "<option value=\"K.M.Hospital\">K.M.Hospital</option>"; 
echo "<option value=\"Lalbag\">Lalbag</option>"; 
echo "<option value=\"Bhaigvala\">Bhaigvala</option>"; 
echo "<option value=\"J.J.Hospital\">J.J.Hospital</option>"; 
echo "<option value=\"Bhendi Bazar\">Bhendi Bazar</option>"; 
echo "<option value=\"Cofread Market\">Cofread Market</option>"; 
echo "<option value=\"Vadala Parking(Last stop)\">Vadala Parking(Last stop)</option>"; 
echo "</select>"; 
echo "</td>"; 
echo "</tr><tr>"; 
