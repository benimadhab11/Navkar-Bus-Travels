...
<h2>Shirpur-Dhule-Bombay(Mumbai)(NON-ACSLEEPERCOACH)</h2>
<h2>Seat Chart</h2>
...
echo"<td><a href='Shirpur-Dhule-Bombay(Mumbai)(NON-ACSLEEPERCOACH).php'><input type='button' value='Add Customer'></input></a></td>";
echo"<td><a href='Shirpur-Dhule-Bombay(Mumbai)(NON-ACSLEEPERCOACH)update.php'><input type='button' value='Update Information'></a></input></td>";
echo"<td><a href='bus90.php'><input type='button' value='Delete_Total Record'></a></input></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
