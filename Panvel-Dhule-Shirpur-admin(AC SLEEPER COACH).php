...
<h2>Panvel-Dhule-Shirpur(AC SLEEPER COACH)</h2>
<h2>Seat Chart</h2>
...
echo"<br><br> <table  border=0 cellpadding=30><tr>";
echo"<td><a href='Panvel-Dhule-Shirpur(AC SLEEPER COACH).php'><input type='button' value='Add Customer'></a></input></td>";
echo"<td><a href='Panvel-Dhule-Shirpur(AC SLEEPER COACH)update.php'><input type='button' value='Update Information'></a></input></td>";
echo"<td><a href='bus80.php'><input type='button' value='Delete seat vise customer'></a></input></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
