...
<html>
<head>
<title>Shirpur-Dhule-Panvel(AC SLEEPER COACH)Select seat</title>
...
<center>
<h1><center>Shirpur-Dhule-panvel(AC SLEEPER COACH)</center></h1>
<h1>Select Seat AND Fill details</h1> 
<h4 style=color:red>*All fields are mandatory to fill</h4>
<form method="post" name="myForm" action="Shirpur-Dhule-panvel(AC SLEEPER COACH)insert.php" onsubmit="return validate()">
