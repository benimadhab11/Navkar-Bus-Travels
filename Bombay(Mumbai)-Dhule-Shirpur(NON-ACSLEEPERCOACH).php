...
<html>
<head>
<title>Bombay(Mumbai)-Dhule-Shirpur(NON-ACSLEEPERCOACH)seat select</title>
...
<center>
<h1><center>Bombay(Mumbai)-Dhule-Shirpur(NON-ACSLEEPERCOACH)</center></h1>
<h1>Select Seat AND Fill details</h1>
<h4 style=color:red>All fields are mandatory to fill</h4>
<form method="post" name="myForm" action="Bombay(Mumbai)-Dhule-Shirpur(NON-ACSLEEPERCOACH)insert.php" onsubmit="return validate()">
