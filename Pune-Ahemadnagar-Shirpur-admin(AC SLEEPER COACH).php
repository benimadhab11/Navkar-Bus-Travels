...
echo"<td><a href='Pune-Ahemadnagar-Shirpur(AC SLEEPER COACH).php'><input type='button' value='Add Customer'></input></a></td>";
echo"<td><a href='Pune-Ahemadnagar-Shirpur(AC SLEEPER COACH)update.php'><input type='button' value='Update Information'></a></input></td>";
echo"<td><a href='bus20.php'><input type='button' value='Delete seat vise customer'></a></input></td>";
echo"</tr>";
echo"</table>";
echo"</center>";
echo"</body>";
